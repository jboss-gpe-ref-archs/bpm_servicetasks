...
.. As of 6.0.2, the WorkItemHandler implementation does not extend AbstractLogOrThrowWorkItemHandler
... WorkItemHandler implementation will extend AbstractLogOrThrowWorkItemHandler in BPM Suite 6.1
. WebService
.. SOAP client leverages Apache CXF Dynamic Dispatch
