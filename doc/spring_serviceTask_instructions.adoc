...
=== local:  deploy the Spring custom work item handler
...
Collectively, the above commands build _wih-1.0.jar_ (which contains the SpringPersistenWIH class) and deploys it as a JBoss Module to the remote BPM Suite 6 runtime environment.
...
=== BPM Suite 6: Define dependency on custom workItemHandler
