 ...
 *       &lt;sequence>
 *         &lt;element name="driver" type="{domain.soa.bpm_servicetasks.refarch.gpe.redhat.com}driver" minOccurs="0"/>
...
@XmlType(name = "policy", namespace = "domain.soa.bpm_servicetasks.refarch.gpe.redhat.com", propOrder = {
    "driver",
    "policyType",
    "price",
    "priceDiscount",
