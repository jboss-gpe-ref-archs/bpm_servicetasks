...
import com.redhat.gpe.refarch.bpm_servicetasks.soa.domain.Policy;
...
public class AuditReviewResource {
    ...
    public Response reviewQuote(@FormParam("policyObj") String pString) {
        ...
        try {
            ...
            Policy policyObj = jsonMapper.readValue(pString, Policy.class);
    ...
    @Produces({ "text/plain" })
    public Response reviewQuote(@HeaderParam("Content-Type") String contentType, Policy policyObj) {
    ...
    private boolean executeBizLogic(Policy policyObj){
